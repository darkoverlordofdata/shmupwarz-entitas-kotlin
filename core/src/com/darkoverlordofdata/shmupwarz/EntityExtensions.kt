...
fun Entity.addLayer(ordinal:com.darkoverlordofdata.shmupwarz.Layer):Entity {
...
fun Entity.replaceLayer(ordinal:com.darkoverlordofdata.shmupwarz.Layer):Entity {
...
fun Entity.addSoundEffect(effect:com.darkoverlordofdata.shmupwarz.Effect):Entity {
...
fun Entity.replaceSoundEffect(effect:com.darkoverlordofdata.shmupwarz.Effect):Entity {
